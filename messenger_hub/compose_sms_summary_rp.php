...
<body>
                                    ...
                                    <div class="card-body">
                                        <form method="post">
                                            <div id="table-1_filter" class="dataTables_filter">
                                                <!-- date filter -->
                                                <div style="width: 20%; padding-right:1%; float: left;">Date :<input
                                                        type="text" name="dates" id="dates" value="<?= $_REQUEST[
                              "dates"
                                                ...
                                                <div style="width: 20%; padding-right:1%; float: left;">
                                                    <input type="submit" name="submit_1" id="submit_1" tabindex="10"
                                                        value="Search" class="btn btn-success "
                                                        style="height:30px; margin-top: 20px;">
                                                </div>
                                            </div>
                                        </form>
                                        <div class="table-responsive" id="id_compose_sms_summary"
    ...
    <!-- Add DOMPurify library to the head section: -->
    ...
    //  compose_sms_summary func
    function compose_sms_summary() {
        dates = $('#dates').val();
        $.ajax({
            type: 'post',
            url: "ajax/display_functions.php?call_function=compose_sms_summary&dates=" + dates + "",
            dataType: 'html',
            beforeSend: function() {
                $('.theme-loader').show();
            },
            ...
            success: function(response) {
                ...
                $("#id_compose_sms_summary").html(sanitizedResponse);
            },
    ...
    $(function() {
        ...
        $('input[name="dates"]').on('apply.daterangepicker', function(event, picker) {
            ...
            compose_sms_summary(); // Call the summary refresh instead
        });
