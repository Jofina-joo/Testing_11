                    ...
                    <div>
                      ...
                      <div class="row mt-2 grid_clr_green">
                        ...
                        <div class="col-6">
                            ...
                            <input type="text" name="clientname_txt" id="clientname_txt" class="form-control" value="<?= $user_name ?>"
                        ...
                        <? if($user_status == 'Y') { 
                             ...
                             <input type="text" name="mobile_no_txt" id="mobile_no_txt" class="form-control" value="<?=$user_mobile ?>"
                      ...
                      <div class="row mt-2 grid_clr_green">
                       ...
                       <? if($user_status == 'Y') { 
                              echo $user_email;
                               ...
                               <input type="text" name="email_id_contact" id="email_id_contact" class="form-control" value="<?=$user_email ?>"
                            maxlength="50" tabindex="5" autofocus="" required="" data-toggle="tooltip"
                            data-placement="top" title="" data-original-title="User Email ID"
                        ...
                        <div class="col-6">
                         <? if($user_status == 'Y') { 
                              ...
                              <input type="text" name="login_id_txt" id="login_id_txt" class="form-control" value="<?= $login_id ?>"
