...
<div id="scrolltop" style="visibility: hidden; opacity: 0;"><a class="top-button" href="#top"><img src="assets/img/up_arrow.png"
...
<footer class="main-footer">
  <div class="footer-left">
    Copyright &copy;
    <?= date("Y") ?>
    <div class="bullet"></div> <a href="https://celebdigital.in/" target="_blank">Celeb Media</a>
  </div>
