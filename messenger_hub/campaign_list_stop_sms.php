...
<body>
        ...
        <section class="section">
          ...
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">SMS List</div>
            </div>
          </div>
  ...
  <script>
    ...
    function campaign_list_stop() {
      $.ajax({
        type: 'post',
        url: "ajax/display_functions.php?call_function=campaign_list_stop_sms",
        dataType: 'html',
    ...
    $('#senderid-Modal-stop').find('.btn-success').on('click', function () {
      ...
      if (txt_whatsapp_mobno == "") {
        ...
        $.ajax({
          type: 'post',
          url: "ajax/message_call_functions.php?tmpl_call_function=send_stop_campaign_sms" + send_code,
          contentType: false,
          processData: false,
          dataType: 'json',
          beforeSend: function () {
    ...
    $('#senderid-Modal-restart').find('.btn-success').on('click', function () {
      ...
      if (txt_whatsapp_mobno == "") {
        ...
        $.ajax({
          type: 'post',
          url: "ajax/message_call_functions.php?tmpl_call_function=send_restart_campaign_sms" + send_code,
          contentType: false,
          processData: false,
          dataType: 'json',
          beforeSend: function () {
