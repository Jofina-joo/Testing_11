                        ...
                        <tbody>
                          ...
                          if ($qur_sntsms->num_rows > 0) {
                            while ($row_sntsms = $qur_sntsms->fetch_assoc()) {
                              ...
                              $mobile_number = $row_sntsms["country_code"] . $row_sntsms["mobile_number"];
