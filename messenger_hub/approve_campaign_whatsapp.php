      ...
      <div class="main-content">
        <section class="section">
          ...
          <div class="section-header">
            <h1>Whatsapp Campaign List</h1>
            <div class="section-header-breadcrumb">
              <div class="breadcrumb-item active"><a href="dashboard">Dashboard</a></div>
              <div class="breadcrumb-item">Whatsapp Campaign List</div>
            </div>
          </div>
          <!-- List Panel -->
  ...
  <div class="modal" tabindex="-1" role="dialog" id="approve-Modal">
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="needs-validation" novalidate="" id="frm_sender_id" name="frm_sender_id" action="#" method="post"
            enctype="multipart/form-data">
            <div class="form-group mb-2 row">
              <label class="col-sm-5 col-form-label">Whatsapp Sender ID <label style="color:#FF0000">*</label></label>
    ...
    <script>
      ...
      function approve_campaign_list() {
        $.ajax({
          type: 'post',
          url: "ajax/display_functions.php?call_function=approve_campaign_list_watsp",
          dataType: 'html',
      ...
      function func_download_rc_no(encodedDatas, indicatori) {
        try {
          ...
          a.href = url;
          a.download = 'approve_campaign_whatsapp.csv';
      ...
      $('#approve-Modal').find('.btn-success').on('click', function () {
        ...
        if (txt_whatsapp_mobno == "") {
          ...
          $.ajax({
            type: 'post',
            url: "ajax/message_call_functions.php?tmpl_call_function=send_approve_campaign_wastp" + send_code,
            contentType: false,
            processData: false,
            dataType: 'json',
            beforeSend: function () {
            ...
            success: function (response) { // Success
              if (response.status == '0' || response.status == 0) {
                 ...
                 $("#id_error_display").html("Message Send Successfully..!");
                setTimeout(function () {
                  window.location = 'approve_campaign_whatsapp';
      ...
      $('#reject-Modal').find('.btn-success').on('click', function () {
        ...
        $("#id_error_reject").html("Reason to reject must be between 4 and 50 characters.");
          ...
          $.ajax({
            type: 'post',
            url: "ajax/message_call_functions.php?tmpl_call_function=send_reject_campaign_wastp" + send_code,
            contentType: false,
            processData: false,
            dataType: 'json',
            beforeSend: function () {
