                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group mb-2 row" id="id_upload_media">
                        <label class="col-sm-3 col-form-label" style="float: left">Upload Media
                          <span data-toggle="tooltip"
                            data-original-title="Upload any Media file [JPG/JPEG/PNG/MP4] below 3 MB Size.">[?]</span></label>
                        <div class="col-sm-4 file_image_header" style="float: left;">
                          <input type="file" accept="image/*, video/mp4" class="form-control"
                            ...
                            title="Upload any Media file [JPG/JPEG/PNG/MP4] below 3 MB Size.">
                        </div>
...
/*else if(textarea.value.trim().length == '') {
  ...
  $("#current_text_value").text(trimmedText.length); // Update the length of trimmed text
    ...
    function preview_content() {
      ...
      $.ajax({
        type: 'post',
        url: "ajax/preview_call_functions.php?preview_functions=preview_compose_whatsapp",
        data: fd,
          ...
          success: function (response) { // Success
            if (response.status == 1) {
              ...
              if (response_msg_split[1] != '') {
                invalid_mobile_nos = "Invalid Mobile Nos : " + response_msg_split[1] + "This Mobile Numbers Are Invalid Mobile Numbers.Are You Sure The Compose Whatsapp ?";
              }
