...
CREATE TABLE IF NOT EXISTS `compose_message_1` (
...
CREATE TABLE IF NOT EXISTS `compose_msg_media_1` (
...
--
-- Table structure for table `compose_msg_status_1`
--

CREATE TABLE IF NOT EXISTS `compose_msg_status_1` (
...
--
-- Indexes for table `compose_msg_status_1`
--
ALTER TABLE `compose_msg_status_1`
...
--
-- AUTO_INCREMENT for table `compose_msg_status_1`
--
ALTER TABLE `compose_msg_status_1`
