...
--
-- Database: `mobile_marketing_3`
--

-- --------------------------------------------------------

--
-- Table structure for table `compose_message_3`
--

CREATE TABLE IF NOT EXISTS `compose_message_3` (
...
--
-- Table structure for table `compose_msg_media_3`
--

CREATE TABLE IF NOT EXISTS `compose_msg_media_3` (
...
--
-- Table structure for table `compose_msg_status_3`
--

CREATE TABLE IF NOT EXISTS `compose_msg_status_3` (
...
--
-- Indexes for table `compose_message_3`
--
ALTER TABLE `compose_message_3`
  ADD PRIMARY KEY (`compose_message_id`),
  ADD KEY `user_id` (`user_id`,`product_id`);

--
-- Indexes for table `compose_msg_media_3`
--
ALTER TABLE `compose_msg_media_3`
  ADD PRIMARY KEY (`compose_msg_media_id`),
  ADD KEY `compose_whatsapp_id` (`compose_message_id`);

--
-- Indexes for table `compose_msg_status_3`
--
ALTER TABLE `compose_msg_status_3`
...
--
-- AUTO_INCREMENT for table `compose_message_3`
--
ALTER TABLE `compose_message_3`
  MODIFY `compose_message_id` int NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `compose_msg_media_3`
--
ALTER TABLE `compose_msg_media_3`
  MODIFY `compose_msg_media_id` int NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `compose_msg_status_3`
--
ALTER TABLE `compose_msg_status_3`
