...
Update Report function to validate the user.
Version : 1.0
...
const UpdateReport = Joi.object().keys({
  ...
  rcs_product_id: Joi.string().required().label("RCS Product ID")


}).options({ abortEarly: false });

//Exports the UpdateReport module
